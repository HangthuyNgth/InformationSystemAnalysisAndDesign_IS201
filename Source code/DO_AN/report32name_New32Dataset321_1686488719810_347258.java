/*
 * Generated by JasperReports - 20:05, 11/06/2023
 */
 ...
 *
 */
public class report32name_New32Dataset321_1686488719810_347258 extends JREvaluator
{
    ...
    private JRFillField field_SL = null;
    ...
    private void initFields(Map fm)
    {
        ...
        field_SL = (JRFillField)fm.get("SL");
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.Integer)field_Date.getValue())+"-"+((java.lang.Integer)field_Month.getValue()); //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.lang.Integer)field_SL.getValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = ((java.lang.Integer)field_SL.getValue()); //$JR_EXPR_ID=10$
                break;
            }
           default :
           {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.Integer)field_Date.getOldValue())+"-"+((java.lang.Integer)field_Month.getOldValue()); //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.lang.Integer)field_SL.getOldValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = ((java.lang.Integer)field_SL.getOldValue()); //$JR_EXPR_ID=10$
                break;
            }
           default :
           {
